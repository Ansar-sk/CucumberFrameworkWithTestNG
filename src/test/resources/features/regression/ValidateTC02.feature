Feature: To Validate TestCase two
@all
...
| Sydney | Hotel Creek | 20/04/2025 | Standard | 1 - One | 19/04/2025 | 1 - One | 0 - None | Check-Out Date shall be after than Check-In Date |

Then User submit the form
Then user validate the error message using "Check-Out Date shall be after than Check-In Date"
